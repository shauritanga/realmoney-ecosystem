  ...
  String _messageText() {
    ...
    if (isPreDue(_item.level)) {
      final due = _item.dueDate.length >= 10
          ...
          : _item.dueDate;
      return 'Habari ${_item.borrowerName}, kumbusho kutoka RealMoney: mkopo wako #${_item.loanNumber} wa TZS $amount unastahili tarehe $due. Tafadhali lipa mapema kupitia ClickPesa USSD ili kuepuka faini. Asante!';
    }
    return 'Habari ${_item.borrowerName}, hili ni kumbusho kutoka RealMoney kuhusu deni lako la mkopo #${_item.loanNumber} la TZS $amount lililochelewa kwa siku ${_item.daysOverdue}. Tafadhali lipa kupitia ClickPesa USSD au wasiliana nasi.';
  }
