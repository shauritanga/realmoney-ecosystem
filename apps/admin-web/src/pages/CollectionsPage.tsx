  ...
  return (
    <div className="space-y-6">
      <PageHeading
        ...
        title="Collections"
        description="Monitor repayment schedules from T-2 to S, push USSD payment prompts, and assign accounts to recovery collectors."
        action={
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                  Bulk assign unassigned cases of a single tier to an active collector.
                </p>
              </div>
              <button
                type="button"
