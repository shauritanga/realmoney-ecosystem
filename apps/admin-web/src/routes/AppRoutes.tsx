...
import { CollectionActivityPage } from '../pages/CollectionActivityPage';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="collections/activity" element={<CollectionActivityPage />} />
        <Route path="collections/extensions" element={<ExtensionsPage />} />
        <Route path="collectors" element={<CollectorsPage />} />
        <Route path="collectors/:id/performance" element={<CollectorPerformancePage />} />
